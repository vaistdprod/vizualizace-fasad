  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded text-sm font-medium cursor-pointer shadow-xs ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        rainbow:
          'group relative inline-flex h-11 cursor-pointer items-center justify-center rounded-xl px-8 py-2 font-medium text-primary-foreground border-0 [background-clip:padding-box,border-box,border-box] [background-origin:border-box] [border:calc(0.08*1rem)_solid_transparent] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring before:absolute before:bottom-[-20%] before:left-1/2 before:z-0 before:h-1/5 before:w-3/5 before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))] before:[filter:blur(calc(0.8*1rem))] bg-[linear-gradient(hsl(var(--primary)/0.9),hsl(var(--primary)/0.9)),linear-gradient(hsl(var(--primary)/0.9)_50%,hsla(var(--primary)/0.45)_80%,hsla(var(--primary)/0)),linear-gradient(90deg,transparent,transparent)] dark:bg-[linear-gradient(hsl(var(--primary)/0.5),hsl(var(--primary)/0.5)),linear-gradient(hsl(var(--primary)/0.5)_50%,hsla(var(--primary)/0.3)_80%,hsla(var(--primary)/0)),linear-gradient(90deg,transparent,transparent)]',
        ripple:
