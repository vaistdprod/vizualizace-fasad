...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_gallery_section_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_gallery_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_faq_section" (
  	...
  	"heading" varchar,
  	"description" varchar,
  	"contact_prompt" varchar DEFAULT 'Máte další otázky?',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_insurance_section" (
  	...
  	"heading" varchar,
  	"description" varchar,
  	"contact_prompt" varchar DEFAULT 'Nevidíte zde svou pojišťovnu? Napište nám pro více informací.',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_appointment_section_appointment_types" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_appointment_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar,
  	"description" varchar,
  	"image_section_image_id" integer,
  	"image_section_title" varchar DEFAULT 'Naše ordinace',
  	"image_section_description" varchar DEFAULT 'Příjemné prostředí pro děti i rodiče',
  	"contact_prompt" varchar,
  	"contact_link_text" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_pricing_section" (
  	...
  	"heading" varchar,
  	"description" varchar,
  	"contact_prompt" varchar DEFAULT 'Máte dotazy k ceníku? Kontaktujte nás.',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_gallery_section_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_gallery_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_appointment_section_appointment_types" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_appointment_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_team_section_team_members" ADD CONSTRAINT "pages_blocks_team_section_team_members_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_gallery_section_images" ADD CONSTRAINT "pages_blocks_gallery_section_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_gallery_section_images" ADD CONSTRAINT "pages_blocks_gallery_section_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_gallery_section"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_gallery_section" ADD CONSTRAINT "pages_blocks_gallery_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_appointment_section_appointment_types" ADD CONSTRAINT "pages_blocks_appointment_section_appointment_types_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_appointment_section"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_appointment_section" ADD CONSTRAINT "pages_blocks_appointment_section_image_section_image_id_media_id_fk" FOREIGN KEY ("image_section_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_appointment_section" ADD CONSTRAINT "pages_blocks_appointment_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_team_section_team_members" ADD CONSTRAINT "_pages_v_blocks_team_section_team_members_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_gallery_section_images" ADD CONSTRAINT "_pages_v_blocks_gallery_section_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_gallery_section_images" ADD CONSTRAINT "_pages_v_blocks_gallery_section_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_gallery_section"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_gallery_section" ADD CONSTRAINT "_pages_v_blocks_gallery_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_appointment_section_appointment_types" ADD CONSTRAINT "_pages_v_blocks_appointment_section_appointment_types_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_appointment_section"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_appointment_section" ADD CONSTRAINT "_pages_v_blocks_appointment_section_image_section_image_id_media_id_fk" FOREIGN KEY ("image_section_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_appointment_section" ADD CONSTRAINT "_pages_v_blocks_appointment_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_team_section_team_members_image_idx" ON "pages_blocks_team_section_team_members" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_section_images_order_idx" ON "pages_blocks_gallery_section_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_section_images_parent_id_idx" ON "pages_blocks_gallery_section_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_section_images_image_idx" ON "pages_blocks_gallery_section_images" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_section_order_idx" ON "pages_blocks_gallery_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_section_parent_id_idx" ON "pages_blocks_gallery_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_section_path_idx" ON "pages_blocks_gallery_section" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_appointment_section_appointment_types_order_idx" ON "pages_blocks_appointment_section_appointment_types" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_appointment_section_appointment_types_parent_id_idx" ON "pages_blocks_appointment_section_appointment_types" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_appointment_section_order_idx" ON "pages_blocks_appointment_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_appointment_section_parent_id_idx" ON "pages_blocks_appointment_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_appointment_section_path_idx" ON "pages_blocks_appointment_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_appointment_section_image_section_image_section_image_idx" ON "pages_blocks_appointment_section" USING btree ("image_section_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_team_section_team_members_image_idx" ON "_pages_v_blocks_team_section_team_members" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_section_images_order_idx" ON "_pages_v_blocks_gallery_section_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_section_images_parent_id_idx" ON "_pages_v_blocks_gallery_section_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_section_images_image_idx" ON "_pages_v_blocks_gallery_section_images" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_section_order_idx" ON "_pages_v_blocks_gallery_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_section_parent_id_idx" ON "_pages_v_blocks_gallery_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_section_path_idx" ON "_pages_v_blocks_gallery_section" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_appointment_section_appointment_types_order_idx" ON "_pages_v_blocks_appointment_section_appointment_types" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_appointment_section_appointment_types_parent_id_idx" ON "_pages_v_blocks_appointment_section_appointment_types" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_appointment_section_order_idx" ON "_pages_v_blocks_appointment_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_appointment_section_parent_id_idx" ON "_pages_v_blocks_appointment_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_appointment_section_path_idx" ON "_pages_v_blocks_appointment_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_appointment_section_image_section_image_section_image_idx" ON "_pages_v_blocks_appointment_section" USING btree ("image_section_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "footer_background_image_idx" ON "footer" USING btree ("background_image_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_gallery_section_images" CASCADE;
  DROP TABLE "pages_blocks_gallery_section" CASCADE;
  ...
  DROP TABLE "pages_blocks_appointment_section_appointment_types" CASCADE;
  DROP TABLE "pages_blocks_appointment_section" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_gallery_section_images" CASCADE;
  DROP TABLE "_pages_v_blocks_gallery_section" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_appointment_section_appointment_types" CASCADE;
  DROP TABLE "_pages_v_blocks_appointment_section" CASCADE;
