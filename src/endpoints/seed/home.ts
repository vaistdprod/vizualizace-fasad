      ...
      blocks: [
        ...
        },
        {
          ...
          partners: [
            ...
            { title: 'RBP', logo: rbpImage.id, url: 'https://www.rbp-zp.cz' },
        ...
        },
        {
          ...
          pricingItems: [
            { title: 'Preventivní prohlídka dítěte', price: '500 Kč' },
            { title: 'Očkování (povinné)', price: '300 Kč' },
            { title: 'Očkování (nepovinné)', price: '500 Kč' },
            { title: 'Kojenecká poradna (1 hodina)', price: '700 Kč' },
            { title: 'Ambulantní vyšetření', price: '600 Kč' },
            { title: 'Diagnostika a léčba (základní)', price: '800 Kč' },
            { title: 'Návštěvní služba (domácí)', price: '1 200 Kč' },
            { title: 'Potvrzení o zdravotním stavu', price: '400 Kč' },
            { title: 'Konzultace s pediatrem (30 minut)', price: '500 Kč' },
            { title: 'Ultrazvuk (břišní)', price: '1 000 Kč' },
            { title: 'Odběr krve', price: '300 Kč' },
            { title: 'Náhradní očkování (po odložení)', price: '450 Kč' },
            { title: 'Poradna pro zdravé děti', price: '600 Kč' },
            { title: 'Monitorování vývoje dítěte', price: '550 Kč' },
            { title: 'Akutní ošetření (mimo ordinační hodiny)', price: '1 500 Kč' },
          ],
